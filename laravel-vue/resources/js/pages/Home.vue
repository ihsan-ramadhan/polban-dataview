    ...
    <div class="home-page">
            ...
            >
                <div class="icon-box">
                    <svg
                        ...
                        :viewBox="card.viewBox || '0 0 24 24'"
                        fill="white"
                        width="32"
                        height="32"
                    >
        ...
        <div class="chart-card">
            ...
            <p class="chart-subtitle">
                Data dummy rasio gender D3 Teknik Informatika (Seluruh Angkatan)
            </p>
...
export default {
    ...
    data() {
        return {
            ...
            // --- Data untuk Kartu Grid (Baru) ---
            statCards: [
                {
                    title: "Jenis Kelamin",
                    desc: "Visualisasi perbandingan jumlah mahasiswa laki-laki dan perempuan di seluruh angkatan.",
                    // Tambahkan viewBox khusus untuk ikon ini (karena ukurannya 80x85)
                    viewBox: "0 0 80 85",
                    /// Ini Path panjang dari SVG yang Anda kirim
                    iconPath:
        ...
        async fetchGenderData() {
            ...
            try {
                const response = await fetch(
                    "http://localhost:6767/api/v1/guest/mahasiswa/gender"
                );
...
<style scoped>
/* --- Variable Colors (Hardcoded for scoped style) --- */
/* Anda bisa memindahkan ini ke global CSS jika perlu */
.home-page {
    --polban-blue: #1a237e; /* Biru tua khas Polban */
    --text-muted: #666;
}

/* --- STYLE BAGIAN 1: Banner --- */
.welcome-banner {
