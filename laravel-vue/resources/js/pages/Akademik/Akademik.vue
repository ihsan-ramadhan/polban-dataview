    ...
    <div class="dashboard-grid-row">
      ...
      <div class="chart-card" ref="chartCardPie">
        ...
        <div class="chart-container">
          ...
          <BasePieChart v-else :chart-data="chartData" :key="renderKey" />
        </div>
      ...
      <div class="chart-card" ref="chartCardBar">
        ...
        <div class="chart-container">
          ...
          <BaseBarChart v-else :chart-data="chartData" :key="renderKey" />
        </div>
...
/* Container Fix: Min-height & Overflow */
.chart-container { 
  position: relative; 
  width: 100%; 
  height: 350px; 
  min-height: 350px; /* Jaga-jaga */
  flex-grow: 1; 
  margin-bottom: auto;
  overflow: hidden; /* Biar chart ga bocor */
}
...
@media (max-width: 576px) { .chart-container { height: 300px; min-height: 300px; } .header-content { flex-direction: column; } }

/* Dropdown Style (Fixed Positioning) */
...
.dropdown-menu {
  ...
  min-width: 200px; z-index: 999; padding: 8px 0;
  animation: fadeIn 0.2s ease-out;
}
/* Jembatan Transparan (Anti-Siksa) */
